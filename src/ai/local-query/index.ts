...
export {
  LocalAiSchemaQueryService,
  type LocalAiSchemaQueryServiceOptions,
  type SchemaParserMode,
} from './LocalAiSchemaQueryService.js';
...
// ─── Core (shared by generic and legacy) ────────────────────
...
export {
  ...
  type TransformersJsProgressReport,
