import { singleton as _, injectable as N, inject as $ } from "tsyringe";
import { makeObservable as F, action as v, observable as R, computed as y, runInAction as p } from "mobx";
import { S as I } from "./SchemaService-DZwkFgZu.js";
import { b as P, A as E, a as M, M as L } from "./relationships-BEXANmWg.js";
import { e as O, p as S } from "./cache-utils-B2wFhisx.js";
class j {
  constructor() {
...
class f {
  ...
  static validateFilterNode(t, e, i, n, o) {
    if (t.kind === "condition") {
      ...
      (a.type ? U[a.type] ?? C : C).has(t.operator) || i.push({
        path: e,
...
class h {
  ...
  static evaluateCondition(t, e) {
    ...
    if (i.length > 1)
      return i.some(
        (o) => h.evaluateSingleCondition(o, e.operator, e.value)
      );
    const n = i[0];
    return h.evaluateSingleCondition(n, e.operator, e.value);
  }
  static evaluateSingleCondition(t, e, i) {
    switch (e) {
      ...
      case "between": {
        ...
        const n = h.compareValues(t, i[0]), o = h.compareValues(t, i[1]);
        return n >= 0 && o <= 0;
      }
      default:
        return !1;
  ...
  static sortRecords(t, e) {
    return [...t].sort((i, n) => {
      for (const o of e) {
        const a = h.resolveFieldValue(i, o.field), r = h.resolveFieldValue(n, o.field);
        if (a === r) continue;
        if (a == null) return 1;
        if (r == null) return -1;
        const l = h.compareValues(a, r);
        if (l !== 0)
...
let g = class {
  ...
  peekRecord(s, t) {
    ...
    return e === null ? null : this.identityMap.get(s, e) ?? null;
  }
  /**
  ...
  pushResource(s) {
    ...
    const i = this.identityMap.get(t, e);
    if (i)
      return p(() => {
        i._applyServerData(null, s.attributes ?? {}, s.relationships);
      }), this.trackInverseForResource(i, s), i;
    const n = this.schema.modelFor(t), o = P.push.call(n, {
      id: e,
      data: s.attributes ?? {},
      relationships: s.relationships,
      store: this
    });
    return this.identityMap.set(t, e, o), this.trackInverseForResource(o, s), o;
  }
  /**
  ...
  addInverse(s, t, e, i) {
    ...
    p(() => {
      if (a.kind === "hasMany") {
        const c = r != null && r.data && Array.isArray(r.data) ? r.data : [];
        c.some((u) => g.refEquals(u, l)) || n._setRelationshipRef(e, { data: [...c, l] });
      } else
  ...
  removeInverse(s, t, e, i) {
    ...
    p(() => {
      if (a.kind === "hasMany") {
        const c = (r != null && r.data && Array.isArray(r.data) ? r.data : []).filter((u) => !(u.id === i.id && u.type === i.modelName));
        n._setRelationshipRef(e, { data: c });
      } else
  ...
  async findRecord(s, t, e = {}) {
    ...
    const o = i ? this.createSnapshot(i) : this.createEmptySnapshot(s, t), a = e.include ? { include: e.include, adapterOptions: e.adapterOptions } : e.adapterOptions ? { adapterOptions: e.adapterOptions } : void 0, r = await n.findRecord(this, s, t, o, a), l = O(r), c = this.serializerFor(s).normalizeResponse(
      this,
      this.schema.modelFor(s),
      r,
      t,
  ...
  createSnapshot(s) {
    ...
    return {
      ...
      hasMany: (o, a) => {
        ...
        return a != null && a.ids ? l.map((c) => c.id) : l.map((c) => this.peekRecord(c.type, c.id)).filter((c) => c !== null);
      },
...
//# sourceMappingURL=Store-BAN_4IWi.js.map
