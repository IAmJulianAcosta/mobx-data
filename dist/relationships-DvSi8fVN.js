...
import { A as v, R as b } from "./types-CC2fG3FP.js";
import { injectable as R } from "tsyringe";
var w = Object.getOwnPropertyDescriptor, A = (o, t, e, i) => {
  for (var r = i > 1 ? void 0 : i ? w(t, e) : t, s = o.length - 1, n; s >= 0; s--)
    (n = o[s]) && (r = n(r) || r);
  return r;
};
let g = class {
...
class M {
  constructor(t) {
    ...
    this._attributeDefinitions = p(i, v), this._relationshipDefinitions = p(i, b);
  }
...
const y = Symbol("mobx-data:accessors-installed");
function S(o, t) {
  const e = [];
  let i = o;
  for (; i && i !== Object.prototype; )
...
class k {
  constructor(t = {}) {
    this._data = {}, this._originalData = {}, this._relationships = /* @__PURE__ */ new Map(), this._id = null, this._clientId = E(), this.errors = new g();
    const e = t;
    F(this.constructor), this._id = e.id ?? null, this.store = e.store, this._stateMachine = new C(
...
//# sourceMappingURL=relationships-DvSi8fVN.js.map
