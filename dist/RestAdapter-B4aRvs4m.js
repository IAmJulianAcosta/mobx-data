...
function x(c, e) {
  const [r, t, s] = f(c, e), n = h(e == null ? void 0 : e.locale), o = S(e == null ? void 0 : e.locale), a = E(n, o);
  return r + t.map(a).join("") + s;
}
function T(c, e) {
  return m(c, { delimiter: "-", ...e });
}
function h(c) {
...
var C = Object.getOwnPropertyDescriptor, g = (c, e, r, t) => {
  for (var s = t > 1 ? void 0 : t ? C(e, r) : e, n = c.length - 1, o; n >= 0; n--)
    (o = c[n]) && (s = o(s) || s);
  return s;
};
...
//# sourceMappingURL=RestAdapter-B4aRvs4m.js.map
