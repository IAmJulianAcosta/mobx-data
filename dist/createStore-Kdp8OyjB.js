...
import { S } from "./SchemaService-DBsdlETO.js";
import { singleton as C, injectable as I, inject as q } from "tsyringe";
import { makeObservable as A, action as k, observable as M, computed as f, runInAction as u } from "mobx";
import { o as $, d as F, b as P, A as x, a as N, M as j } from "./relationships-QsV_R5xe.js";
import { e as _, p as O, R as L } from "./RestAdapter-CYInlScn.js";
import { M as m } from "./MdqlMemoryExecutor-ClRyEFJj.js";
import { J as Q } from "./JsonSerializer-DpRkJtYG.js";
class U {
  constructor() {
    this._buckets = /* @__PURE__ */ new Map(), A(this, {
      _buckets: $,
      set: k,
      delete: k,
      clear: k
  ...
  bucket(t, s = !1) {
    ...
    return !i && s && (i = M.map({}, { deep: !1 }), this._buckets.set(t, i)), i;
  }
...
class v {
  constructor(t) {
    this.updating = !1, this.opts = t, A(this, {
...
class G extends v {
  constructor(t) {
    super(t), this.queryParams = t.query, this.metaData = t.meta ?? {}, this.linksData = t.links ?? {}, A(this, {
      metaData: F,
      linksData: F,
      meta: f,
      links: f,
...
class p {
  ...
  static validateFilterNode(t, s, i, r, n) {
    if (t.kind === "condition") {
      ...
      (o.type ? W[o.type] ?? z : z).has(t.operator) || i.push({
        path: s,
...
class R {
  ...
  and(t) {
    const s = new R(this.store, this.queryModelName);
    t(s);
  ...
  async toArray() {
    ...
    return m.executeMany(s, t);
  }
  async first() {
    const t = this.toQueryObject();
    p.validate(t, this.store.schema);
    const s = this.store.peekAll(this.queryModelName).toArray();
    return m.executeOne(s, t);
  }
  async count() {
    const t = this.toQueryObject();
    p.validate(t, this.store.schema);
  ...
  toLiveArray() {
    const t = this.toQueryObject();
    p.validate(t, this.store.schema);
    const s = m.compilePredicate(t);
    return this.store.liveQuery(this.queryModelName, s);
  }
}
var V = Object.getOwnPropertyDescriptor, K = (e, t, s, i) => {
  for (var r = i > 1 ? void 0 : i ? V(t, s) : t, n = e.length - 1, o; n >= 0; n--)
    (o = e[n]) && (r = o(r) || r);
  return r;
}, J = (e, t) => (s, i) => t(s, i, e);
let y = class {
  constructor(e) {
    this.identityMap = new U(), this.adapters = /* @__PURE__ */ new Map(), this.serializers = /* @__PURE__ */ new Map(), this.newRecords = /* @__PURE__ */ new Map(), this.newRecordTypes = /* @__PURE__ */ new WeakMap(), this.relationshipCache = /* @__PURE__ */ new WeakMap(), this.pendingMembers = /* @__PURE__ */ new WeakMap(), this._cache = null, this.coalescePending = /* @__PURE__ */ new Map(), this.coalesceScheduled = /* @__PURE__ */ new Set(), this.schema = e;
  }
  ...
  async findRecord(e, t, s = {}) {
    ...
    const n = i ? this.createSnapshot(i) : this.createEmptySnapshot(e, t), o = s.include ? { include: s.include, adapterOptions: s.adapterOptions } : s.adapterOptions ? { adapterOptions: s.adapterOptions } : void 0, a = await r.findRecord(this, e, t, n, o), l = _(a), h = this.serializerFor(e).normalizeResponse(
      this,
      this.schema.metaFor(e),
      a,
      t,
   ...
   */
  async findAll(e, t = {}) {
    const s = this.adapterFor(e), i = t.include ? { include: t.include, adapterOptions: t.adapterOptions } : t.adapterOptions ? { adapterOptions: t.adapterOptions } : void 0, r = await s.findAll(this, e, null, [], i), n = _(r), o = this.serializerFor(e).normalizeResponse(
      this,
      this.schema.metaFor(e),
      r,
      null,
  ...
  async saveRecord(e, t = {}) {
    ...
    const o = this.serializerFor(e.modelName).normalizeResponse(
      this,
      this.schema.metaFor(e.modelName),
      n,
      e.id,
  ...
  serialize(e = {}) {
    ...
    for (const [r, n] of s) {
      ...
      for (const [l, h] of n) {
        ...
        if (o && o.length > 0) {
          d = {};
          for (const [g, w] of Object.entries(c._data))
            o.includes(g) || (d[g] = w);
        } else
          d = { ...c._data };
        const b = {
        ...
        if (c._relationships && c._relationships.size > 0) {
          const g = {};
          for (const [w, T] of c._relationships)
            g[w] = T;
          b.relationships = g;
        }
        a.push(b);
...
function nt(e) {
  ...
  const s = new y(t), i = e.adapter ?? new L(), r = e.serializer ?? new Q();
  for (const n of e.models)
...
//# sourceMappingURL=createStore-Kdp8OyjB.js.map
