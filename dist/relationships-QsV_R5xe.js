...
import { observable as u, makeObservable as l, action as d, computed as a, runInAction as h } from "mobx";
import { A as R, R as w } from "./types-CC2fG3FP.js";
import { injectable as E } from "tsyringe";
const A = M, D = u;
function C(o, t, e) {
  const i = o ?? t;
  if (i === void 0)
    throw new Error(
      `Unsupported MobX version: no "${e}" annotation found. mobx-data requires mobx ^6.0.0 || ^7.0.0.`
    );
  return i;
}
const f = C(
...
var F = Object.getOwnPropertyDescriptor, O = (o, t, e, i) => {
  for (var r = i > 1 ? void 0 : i ? F(t, e) : t, s = o.length - 1, n; s >= 0; s--)
    (n = o[s]) && (r = n(r) || r);
  return r;
};
let _ = class {
  constructor() {
    this._errors = /* @__PURE__ */ new Map(), l(this, {
      _errors: p,
      isEmpty: a,
      length: a,
      add: d,
...
class I {
  constructor(t) {
    this.record = t, this.id = t.id, this.clientId = t._clientId, this.modelName = t.modelName;
    const e = t;
    ...
    this._attributeDefinitions = y(i, R), this._relationshipDefinitions = y(i, w);
  }
...
const b = Symbol("mobx-data:accessors-installed");
function v(o, t) {
  const e = [];
  let i = o;
  for (; i && i !== Object.prototype; )
...
class x {
  constructor(t = {}) {
    this._data = {}, this._originalData = {}, this._relationships = /* @__PURE__ */ new Map(), this._id = null, this._clientId = k(), this.errors = new _();
    const e = t;
    L(this.constructor), this._id = e.id ?? null, this.store = e.store, this._stateMachine = new P(
  ...
  async save(t = {}) {
    ...
    try {
      return await this.store.saveRecord(this, t), (this.currentState === "root.loaded.created.inFlight" || this.currentState === "root.loaded.updated.inFlight") && h(() => {
...
class U {
  constructor(t) {
    this.loadedState = "pending", this.currentValue = null, this.error = null, this.inflight = null, this.host = t, l(this, {
      loadedState: u,
      currentValue: f,
      error: f,
      isPending: a,
...
class W {
  constructor(t) {
    this.loadedState = "pending", this.error = null, this.inflight = null, this.host = t, this.manyArray = new c(t), l(this, {
      loadedState: u,
      error: f,
      isPending: a,
      isFulfilled: a,
  ...
  load() {
    ...
    if (this.inflight)
      return this.inflight;
    const t = this.host.store._getRelationshipRefFor(this.host.parent, this.host.name), r = c.refData(t).filter(
...
//# sourceMappingURL=relationships-QsV_R5xe.js.map
